        ...
        <div id="right-side">
	        ...
	        <div align="center" class="paging-area">
	        	...
	        	<%if(pi.getCurrentPage() != 1){ %>
		        	<button class="paging-btn" onclick="location.href='<%=contextPath%>/managerOrder.ma?currentPage=<%=pi.getCurrentPage()-1%>&num=<%=num%>'">&lt;</button>
		        <%}else{ %>
		        ...
		        <%for(int i=pi.getStartPage(); i<=pi.getEndPage(); i++){ %>
		        	...
		        	<%}else{ %>
		        		<button class="paging-btn" onclick="location.href='<%=contextPath%>/managerOrder.ma?currentPage=<%=i%>&num=<%=num%>'"><%=i%></button>
		        	 <%} %>
		        <%} %>
