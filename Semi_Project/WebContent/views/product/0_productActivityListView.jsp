    ...
    <div class="outer">
       ...
       <hr style="border: 3px solid rgba(255, 221, 0, 0.126);;">
        ...
        <div id="left-side" class="inline-block" align="center">
            <ol id="mem-center">
                <li style="font-weight:bold; background-color: rgba(255, 221, 0, 0.343);"><a href="<%=contextPath %>/activity.li">체험상품</a></li>
