<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"
	import="java.text.*,java.util.ArrayList,com.semi.product.model.vo.Product"%>

<%
	ArrayList<Product> list = (ArrayList<Product>) request.getAttribute("list");
DecimalFormat df = new DecimalFormat("###,###");
 String masterStore = list.get(0).getStrName();
 int masterNo = list.get(0).getMstNo();
%>
<!DOCTYPE html>
<html>
<head>
...
<%@ include file="../common/menubar.jsp" %>
    <div class="outer">
        <div class="header" align="center">
            <p style="font-size: 40px;"><%=masterStore %></p>
            <br>
       ...
       <hr style="border: 3px solid rgba(255, 221, 0, 0.126);;">
        ...
        <div id="left-side" class="inline-block" align="center">
            <ol id="mem-center">
                <li style="font-weight:bold; background-color: rgba(255, 221, 0, 0.343);"><a href="<%=contextPath %>/masterStore.li?mno=<%=masterNo %>"><%=masterStore %></a></li>
...
<br><br><br><br><br><br>
    ...
    <script>
		...
		$(".list-area").on("click",".thumbnail",function(){
			<%if(list.get(0).getCategoryName().equals("0.체험")){ %>
			location.href="<%=contextPath%>/detail.ac?pno="+ $(this).children().eq(0).val();
			<%}else{%>
