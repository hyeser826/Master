 ...
 */
@WebServlet("/detail.qnam")
public class QnaDetailMiniCtlr extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QnaDetailMiniCtlr() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(b!=null) {
			...
			if(pnoList!=null) {
				...
				request.getRequestDispatcher("/views/board/qnaDetailViewMini.jsp").forward(request, response);				
