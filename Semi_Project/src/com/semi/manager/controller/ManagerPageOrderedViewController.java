...
/**
 * Servlet implementation class ManagerPageOrderViewController
 */
@WebServlet("/managerOrder.ma")
public class ManagerPageOrderedViewController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ManagerPageOrderedViewController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new ManagerService().selectMemberListCount();
		...
		ArrayList<Member> list = new ManagerService().selectOrderedMemberList(pi,num);
		...
		try {
			...
			request.getRequestDispatcher("/views/manager/managerPageOrderedView.jsp").forward(request, response);
			}
