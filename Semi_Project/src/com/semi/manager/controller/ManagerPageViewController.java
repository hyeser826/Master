...
/**
 * Servlet implementation class ManagerPageViewController
 */
@WebServlet("/manager.ma")
public class ManagerPageViewController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ManagerPageViewController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Member> list = new ManagerService().selectMemberList(pi);
