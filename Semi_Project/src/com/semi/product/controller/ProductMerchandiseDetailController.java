...
/**
 * Servlet implementation class ProductMerchandiseDetailController
 */
@WebServlet("/detail.md")
public class ProductMerchandiseDetailController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProductMerchandiseDetailController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(result>0) {
			...
			request.getRequestDispatcher("/views/product/1_product-merchandiseDetailView.jsp").forward(request, response);
