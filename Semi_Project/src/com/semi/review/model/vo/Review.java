...
public class Review {
	...
	public Review(int productBoardNo, String productBoardContent, Date productBoardDate, String memId) {
		super();
	...
	public Review(int productBoardNo, int productNo, int memNo, String productBoardContent, Date productBoardDate,
			String status, String productName, String memId) {
		super();
		this.productBoardNo = productBoardNo;
	...
	private String memId; // 멤버번호로 조회해올 아이디 변수
	...
	public String toString() {
		return "Review [productBoardNo=" + productBoardNo + ", productNo=" + productNo + ", memNo=" + memNo
				...
				+ ", status=" + status + ", productName=" + productName + ", memId=" + memId + "]";
	}
